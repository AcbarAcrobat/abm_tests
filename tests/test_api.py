...
class TestApi:
    ...
    def test_get_user_by_string_id_with_null(self):
        r = requests.post(TeD.url() + "/user/username", json={"token": "  ",
                                                              "username": "  "})
        AssertThat(r.status_code).IsEqualTo(401)
        print(r.json())
        print(r.status_code)
    ...
    def test_get_user_by_string_id_and_token(self):
        r = requests.post(TeD.url() + "/user/id", json={"token": H.tok3n(),
                                                        "id": H.get_id()})
        AssertThat(r.status_code).IsEqualTo(200)
    ...
    def test_get_user_by_string_id_and_token_null(self):
        r = requests.post(TeD.url() + "/user/id", json={"token": " ",
                                                        "id": H.get_id()})
        AssertThat(r.status_code).IsEqualTo(401)
        print(r)
    ...
    def test_get_regions_by_token(self):
        r = requests.post(TeD.url() + "/user/regions", json={"token": H.tok3n()})
        AssertThat(r.status_code).IsEqualTo(200)
        print(r.json())
        print(r)

    def test_get_regions_by_incorrect_token(self):
        r = requests.post(TeD.url() + "/user/regions", json={"token": randomPassword()})
        AssertThat(r.status_code).IsEqualTo(401)
        print(r)

    def test_get_regions_by_token_null(self):
        r = requests.post(TeD.url() + "/user/regions", json={"token": "   "})
        AssertThat(r.status_code).IsEqualTo(401)
        print(r)

    def test_get_workgroup_by_token_and_region(self):
        r = requests.post(TeD.url() + "/region/workgroup", json={"token": H.tok3n(),
    ...
    def test_get_workgroup_by_incorrect_token_and_correct_region(self):
        r = requests.post(TeD.url() + "/region/workgroup", json={"token": randomPassword(),
                                                                 "region": H.get_user_regions()})
        AssertThat(r.status_code).IsEqualTo(401)
        print(r.json())
        print(r)
    ...
    def test_get_workgroup_by_empty_token_and_correct_region(self):
        r = requests.post(TeD.url() + "/region/workgroup", json={"token": "                         ",
                                                                 "region": H.get_user_regions()})
        AssertThat(r.status_code).IsEqualTo(401)
        print(r.json())
        print(r)
